...
// $Rev: 52393 $
// File generated on 20.05.2021 15:45:23 from Type Library described below.
...
//   Hint: Parameter 'set' of IAdditionFormatParam.SetObjectsOptions changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetTextExportForm changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetCreateLocalComponents changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetStepType changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetStep changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetAngle changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetLength changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetMaxTeselationCellCount changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetLengthUnits changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetStitchSurfaces changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetStitchPrecision changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetNeedCreateComponentsFiles changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetSaveResultDocument changed to 'set_'
//   Hint: Parameter 'set' of IAdditionFormatParam.SetConfiguration changed to 'set_'
...
uses Windows, ActiveX, ks2DCOM_TLB;
...
const
  ...
  IID_IProcess3DNotify: TGUID = '{0712DCCC-83E0-429E-AB8C-5B255DD3C4E4}';
  IID_IProcess3DManipulatorsNotify: TGUID = '{45B82B5C-D0B7-4AC5-965C-26B09612CBF6}';
type
...
// *********************************************************************//
  ...
  IProcess3DNotify = interface;
  IProcess3DManipulatorsNotify = interface;
...
// *********************************************************************//
  ...
  PIEmbodiment3D             = ^IEmbodiment3D;
  PIProcess3DNotify          = ^IProcess3DNotify;
...
// *********************************************************************//
  IDocument3D = interface(IUnknown)
    ...
    function UserSelectEntity(const defSelectObject: IEntity; fnFilter: Pointer; prompt: PWideChar): PIEntity; stdcall;
    ...
    function RunTakeCreateObjectProc(processType: Integer; const takeObject: IUnknown;
                                     needCreateTakeObj: Integer; lostTakeObj: Integer): Integer; stdcall;
    function LoadFromAdditionFormat(fileName: PWideChar; const par: PIAdditionFormatParam): Integer; stdcall;
    function GetLastFeature: PIFeature; stdcall;
    function GetMatesMultiCreatedMode: Integer; stdcall;
    function SetMatesMultiCreatedMode(val: Integer): Integer; stdcall;
  end;
...
// *********************************************************************//
  ISurface = interface(IUnknown)
    ...
    function GetBoundaryUVNurbs(uv: Integer; closed: Integer; loopIndex: Integer; 
                                ...
                                var weights: OleVariant; var knots: OleVariant;
                                var tMin: Double; var tMax: Double): Integer; stdcall;
    function GetBoundaryCount: Integer; stdcall;
    function GetEdgesCount(loopIndex: Integer): Integer; stdcall;
    function GetAreaEx(bitVector: LongWord; angleTolerance: Double): Double; stdcall;  end;
...
// *********************************************************************//
  INurbsSurfaceParam = interface(IUnknown)
    ...
    function GetUVPointFromBoundaryParameter(uv: Integer; closed: Integer; loopIndex: Integer; 
                                             edgeIndex: Integer; t: Double; var u: Double; 
                                             var v: Double): Integer; stdcall;
    function GetBoundaryParameterFromUVPoint(uv: Integer; closed: Integer; loopIndex: Integer; 
                                             edgeIndex: Integer; u: Double; v: Double; var t: Double): Integer; stdcall;
  end;
...
// *********************************************************************//
  IOrientedEdge = interface(IUnknown)
    ...
    function IsSeam: Integer; stdcall;
    function IsPole: Integer; stdcall;
  end;
...
// *********************************************************************//
  IEdgeDefinition = interface(IUnknown)
    ...
    function GetEntity: PIEntity; stdcall;
    function IsValid: Integer; stdcall;
    function GetSketchEdge: Integer; stdcall;
  end;
...
// *********************************************************************//
  IVertexDefinition = interface(IUnknown)
    ...
    function GetSketchVertex: Integer; stdcall;
  end;
...
// *********************************************************************//
  ITessellation = interface(IUnknown)
    ...
    function GetFacetParams(var params: OleVariant): Integer; stdcall;
...
// *********************************************************************//
  IPlacement = interface(IUnknown)
    ...
    function GetVector(type_: Integer; var x: Double; var y: Double; var z: Double): Integer; stdcall;
    ...
    function GetMatrix3D(var Result: OleVariant): Integer; stdcall;
    function Rotate(X0: Double; Y0: Double; Z0: Double; AxisZX: Double; AxisZXY: Double;
                    AxisZZ: Double; angle: Double): Integer; stdcall;
  end;
...
// *********************************************************************//
  IRequestInfo = interface(IUnknown)
    ...
    function GetTakeProcessObject: IUnknown; stdcall;
    function SetTakeProcessObject(const takeObject: IUnknown): Integer; stdcall;
    function GetTakeObjectCallBack: Pointer; stdcall;
    function SetTakeObjectCallBack(callBack: Pointer): Integer; stdcall;
    function GetSelectionBandMode: Integer; stdcall;
    function SetSelectionBandMode(f: Integer): Integer; stdcall;
    function GetProcessingGroupObjectsCallBack: Pointer; stdcall;
    function SetProcessingGroupObjectsCallBack(callBack: Pointer): Integer; stdcall;
    function SetObjectsFilter3D(filterType: Integer; newVal: Integer): Integer; stdcall;
    function GetObjectsFilter3D(filterType: Integer): Integer; stdcall;
  end;
...
// *********************************************************************//
  IAdditionFormatParam = interface(IUnknown)
    ...
    function GetObjectsOptions(option: Integer): Integer; stdcall;
    function SetObjectsOptions(option: Integer; set_: Integer): Integer; stdcall;
    function GetTextExportForm: Integer; stdcall;
    function SetTextExportForm(set_: Integer): Integer; stdcall;
    function GetCreateLocalComponents: Integer; stdcall;
    function SetCreateLocalComponents(set_: Integer): Integer; stdcall;
    function GetPlacement: IPlacement; stdcall;
    function SetPlacement(const p: IPlacement): Integer; stdcall;
    function GetStepType: Integer; stdcall;
    function SetStepType(set_: Integer): Integer; stdcall;
    function GetStep: Double; stdcall;
    function SetStep(set_: Double): Integer; stdcall;
    function GetAngle: Double; stdcall;
    function SetAngle(set_: Double): Integer; stdcall;
    function GetLength: Double; stdcall;
    function SetLength(set_: Double): Integer; stdcall;
    function GetMaxTeselationCellCount: Integer; stdcall;
    function SetMaxTeselationCellCount(set_: Integer): Integer; stdcall;
    function GetLengthUnits: Integer; stdcall;
    function SetLengthUnits(set_: Integer): Integer; stdcall;
    function GetStitchSurfaces: Integer; stdcall;
    function SetStitchSurfaces(set_: Integer): Integer; stdcall;
    function GetStitchPrecision: Double; stdcall;
    function SetStitchPrecision(set_: Double): Integer; stdcall;
    function GetAuthor: PWideChar; stdcall;
    function SetAuthor(val: PWideChar): Integer; stdcall;
    function GetOrganization: PWideChar; stdcall;
    function SetOrganization(val: PWideChar): Integer; stdcall;
    function GetComment: PWideChar; stdcall;
    function SetComment(val: PWideChar): Integer; stdcall;
    function GetPassword: PWideChar; stdcall;
    function SetPassword(val: PWideChar): Integer; stdcall;
    function GetNeedCreateComponentsFiles: Integer; stdcall;
    function SetNeedCreateComponentsFiles(set_: Integer): Integer; stdcall;
    function GetSaveResultDocument: Integer; stdcall;
    function SetSaveResultDocument(set_: Integer): Integer; stdcall;
    function GetConfiguration: OleVariant; stdcall;
    function SetConfiguration(set_: OleVariant): Integer; stdcall;
    function GetConfigurationFileName: PWideChar; stdcall;
    function SetConfigurationFileName(val: PWideChar): Integer; stdcall;
    function SaveConfigurationFile(val: PWideChar): Integer; stdcall;
    function LoadConfigurationFile(val: PWideChar): Integer; stdcall;
  end;
...
// *********************************************************************//
  IViewProjectionCollection = interface(IUnknown)
    ...
    function GetViewProjectionScheme: Integer; stdcall;
    function SetViewProjectionScheme(scheme: Integer): Integer; stdcall;
    function SetBaseUserOrientation(const place: OleVariant): Integer; stdcall;
    function GetBaseUserOrientation(const place: OleVariant): Integer; stdcall;
    function AddUnfoldProjection(const place: OleVariant): IViewProjection; stdcall;
  end;
...
// *********************************************************************//
  IViewProjection = interface(IUnknown)
    ...
    function GetUserProjectionIndex: Integer; stdcall;
    function SetMatrix3D(Matrix3D: OleVariant): Integer; stdcall;
    function GetViewProjectonType: Integer; stdcall;
  end;
...
// *********************************************************************//
  IDocument3DNotify = interface(IKompasNotify)
    ...
    function BeginRollbackFeatures: WordBool; stdcall;
    function RollbackFeatures: WordBool; stdcall;
    function BedinLoadCombinationChange(index: Integer): WordBool; stdcall;
    function LoadCombinationChange(index: Integer): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IObject3DNotify = interface(IKompasNotify)
    ...
    function BeginLoadStateChange(const obj: IUnknown; loadState: Integer): WordBool; stdcall;
    function LoadStateChange(const obj: IUnknown; loadState: Integer): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IProcess3DNotify = interface(IKompasNotify)
    ['{0712DCCC-83E0-429E-AB8C-5B255DD3C4E4}']
    function PlacementChange(const obj: IUnknown): WordBool; stdcall;
    function ExecuteCommand(command: Integer): WordBool; stdcall;
    function Run: WordBool; stdcall;
    function Stop: WordBool; stdcall;
    function Activate: WordBool; stdcall;
    function Deactivate: WordBool; stdcall;
    function FilterObject(const obj: IUnknown): WordBool; stdcall;
    function CreateTakeObject(const obj: IUnknown): WordBool; stdcall;
    function EndProcess: WordBool; stdcall;
    function ProcessingGroupObjects(groupObjects: OleVariant; selectionType: Integer): WordBool; stdcall;
    function AbortProcess: WordBool; stdcall;
  end;
...
// *********************************************************************//
  IProcess3DManipulatorsNotify = interface(IKompasNotify)
    ['{45B82B5C-D0B7-4AC5-965C-26B09612CBF6}']
    function RotateManipulator(ManipulatorId: Integer; X0: Double; Y0: Double; Z0: Double;
                               AxisZX: Double; AxisZXY: Double; AxisZZ: Double; angle: Double;
                               FromEdit: WordBool): WordBool; stdcall;
    function MoveManipulator(ManipulatorId: Integer; VX: Double; VY: Double; VZ: Double;
                             Delta: Double; FromEdit: WordBool): WordBool; stdcall;
    function ClickManipulatorPrimitive(ManipulatorId: Integer; PrimitiveType: Integer;
                                       DoubleClick: WordBool): WordBool; stdcall;
    function BeginDragManipulator(ManipulatorId: Integer; PrimitiveType: Integer): WordBool; stdcall;
    function EndDragManipulator(ManipulatorId: Integer; PrimitiveType: Integer): WordBool; stdcall;
    function CreateManipulatorEdit(ManipulatorId: Integer; PrimitiveType: Integer): WordBool; stdcall;
    function DestroyManipulatorEdit(ManipulatorId: Integer): WordBool; stdcall;
    function ChangeManipulatorValue(ManipulatorId: Integer; PrimitiveType: Integer; newValue: Double): WordBool; stdcall;
  end;
