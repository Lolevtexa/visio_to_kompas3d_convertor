...
//  Если присылается NULL, соответствующее поле не заполняется.
//-------------------------------------------------------------------------
int LIB_FUNC ksGetAttrTypeInfo( reference     pAttr,                    // указатель атрибута
                                double      * numb,                     // номер типа атрибута
                                char        * attrTypeName,             // Имя типа аттрибута 
                                unsigned int  attrTypeNameSize,         // размер выделенной памяти под attrTypeName
                                char        * attrTypeFileName,         // Имя файла где описан тип аттрибута
                                unsigned int  attrTypeFileNameSize,     // размер выделенной памяти под attrTypeFileName    
                                char        * attrTypePathInFile,       // Путь к типу внутри библиотеки
                                unsigned int  attrTypePathInFileSize ); // размер выделенной памяти под attrTypePathInFile    
...
//  Если присылается NULL, соответствующее поле не заполняется.
//-------------------------------------------------------------------------
int LIB_FUNC ksGetAttrTypeInfoW( reference     pAttr,                    // указатель атрибута
                                 double      * numb,                     // номер типа атрибута
                                 LPWSTR        attrTypeName,             // Имя типа аттрибута 
                                 unsigned int  attrTypeNameSize,         // размер выделенной памяти под attrTypeName
                                 LPWSTR        attrTypeFileName,         // Имя файла где описан тип аттрибута
                                 unsigned int  attrTypeFileNameSize,     // размер выделенной памяти под attrTypeFileName    
                                 LPWSTR        attrTypePathInFile,       // Путь к типу внутри библиотеки
                                 unsigned int  attrTypePathInFileSize ); // размер выделенной памяти под attrTypePathInFile    
  
#ifdef _UNICODE
#define ksGetAttrTypeInfoT  ksGetAttrTypeInfoW
#else
#define ksGetAttrTypeInfoT  ksGetAttrTypeInfo
#endif // !UNICODE
