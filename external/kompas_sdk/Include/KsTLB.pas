...
const
  ...
  DIID_ksSaveToPreviusParam: TGUID = '{CF0E948C-5A9D-49A3-BC86-EEA3050193E0}';
type
...
// *********************************************************************//
  ...
  ksSaveToPreviusParam = dispinterface;
...
// *********************************************************************//
  KompasObject = dispinterface
    ...
    property currentDirectory: WideString dispid 137;
    ...
    function ksGetDocumentTypeByNameEx(const fileName: WideString; var docType: Integer; 
                                       var errorId: Integer): WideString; dispid 138;
  end;
...
// *********************************************************************//
  ksDocument2D = dispinterface
    ...
    function ksSetMixDlgMaterialParam(const material: WideString; density: Double): Integer; dispid 254;
  end;
...
// *********************************************************************//
  ksDocument3D = dispinterface
    ...
    property matesMultiCreatedMode: WordBool dispid 90;
    ...
    function GetLastFeature: IDispatch; dispid 89;
  end;
...
// *********************************************************************//
  ksDocument3DNotify = dispinterface
    ...
    function BeginRollbackFeatures: WordBool; dispid 14;
    function RollbackFeatures: WordBool; dispid 15;
    function BedinLoadCombinationChange(index: Integer): WordBool; dispid 16;
    function LoadCombinationChange(index: Integer): WordBool; dispid 17;
  end;
...
// *********************************************************************//
  ksObject3DNotify = dispinterface
    ...
    function BeginLoadStateChange(const obj: IDispatch; loadState: Integer): WordBool; dispid 13;
    function LoadStateChange(const obj: IDispatch; loadState: Integer): WordBool; dispid 14;
  end;
...
// *********************************************************************//
  ksKompasObjectNotify = dispinterface
    ...
    function IsNeedConvertToSavePrevious(const pDoc: IDispatch; docType: Integer; 
                                         saveVersion: Integer; const saveToPreviusParam: IDispatch; 
                                         var needConvert: WordBool): WordBool; dispid 15;
    function BeginConvertToSavePrevious(const pDoc: IDispatch; docType: Integer; 
                                        saveVersion: Integer; const saveToPreviusParam: IDispatch): WordBool; dispid 16;
    function EndConvertToSavePrevious(const pDoc: IDispatch; docType: Integer; 
                                      saveVersion: Integer; const saveToPreviusParam: IDispatch): WordBool; dispid 17;
    function ChangeTheme(newTheme: Integer): WordBool; dispid 18;
    function BeginDragOpenFiles(var filesList: OleVariant; insert: WordBool; 
                                var filesListChanged: WordBool): WordBool; dispid 19;
  end;
...
// *********************************************************************//
  ksDocumentFileNotify = dispinterface
    ...
    function BeginAutoSaveDocument(const fileName: WideString): WordBool; dispid 13;
    function AutoSaveDocument: WordBool; dispid 14;
  end;
...
// *********************************************************************//
  ksMathematic2D = dispinterface
    ...
    function ksDistanceCurveCurve(p1: Integer; p2: Integer; out distanse: Double; out t1: Double; 
                                  out t2: Double): Integer; dispid 53;
  end;
...
// *********************************************************************//
  ksSpecification = dispinterface
    ...
    function ksGetSpcObjectSummaryCountText(spcObj: Integer; ispoln: Integer; block: Integer): IDispatch; dispid 51;
  end;
...
// *********************************************************************//
  ksRequestInfo3D = dispinterface
    ...
    property SelectionBandMode: Integer dispid 29;
    ...
    function GetProcessingGroupObjectsCallBack: WideString; dispid 30;
    function SetProcessingGroupObjectsCallBack(const methodName: WideString; hInst: OleVariant; 
                                               const dispatchOCX: IDispatch): WordBool; dispid 31;
    function SetObjectsFilter3D(filterType: Integer; newVal: WordBool): WordBool; dispid 32;
    function GetObjectsFilter3D(filterType: Integer): WordBool; dispid 33;
  end;
...
// *********************************************************************//
  ksFaceDefinition = dispinterface
    ...
    function GetAreaEx(bitVector: LongWord; angleTolerance: Double): Double; dispid 22;
  end;
...
// *********************************************************************//
  ksEdgeDefinition = dispinterface
    ...
    property sketchEdge: WordBool readonly dispid 16;
  end;
...
// *********************************************************************//
  ksRasterFormatParam = dispinterface
    ...
    property saveWorkArea: WordBool dispid 12;
    property returnResultAsArrayBytes: WordBool dispid 13;
    property resultArrayBytes: OleVariant dispid 14;
    function Init: WordBool; dispid 11;
  end;
...
// *********************************************************************//
  ksAdditionFormatParam = dispinterface
    ...
    property needCreateComponentsFiles: WordBool dispid 23;
    property saveResultDocument: WordBool dispid 24;
    property configuration: OleVariant dispid 25;
    property configurationFileName: WideString dispid 26;
    function Init: WordBool; dispid 4;
    ...
    function SaveConfigurationFile(const fileName: WideString): Integer; dispid 27;
    function LoadConfigurationFile(const fileName: WideString): Integer; dispid 28;
  end;
...
// *********************************************************************//
  ksVertexDefinition = dispinterface
    ...
    property sketchVertex: WordBool readonly dispid 5;
  end;
...
// *********************************************************************//
  ksSurface = dispinterface
    ...
    function GetAreaEx(bitVector: LongWord; angleTolerance: Double): Double; dispid 37;
  end;
...
// *********************************************************************//
  ksOrientedEdge = dispinterface
    ...
    function IsStraight: Integer; dispid 7;
    function IsSeam: Integer; dispid 8;
    function IsPole: Integer; dispid 9;
  end;
...
// *********************************************************************//
// DispIntf:  ksSaveToPreviusParam
// Flags:     (4096) Dispatchable
// GUID:      {CF0E948C-5A9D-49A3-BC86-EEA3050193E0}
// *********************************************************************//
  ksSaveToPreviusParam = dispinterface
    ['{CF0E948C-5A9D-49A3-BC86-EEA3050193E0}']
    function AddWarning(const uniqueID: WideString; const optionName: WideString; 
                        const text: WideString): WordBool; dispid 1;
    function AddOption(const uniqueID: WideString; const optionName: WideString; 
                       options: OleVariant; const defaultValue: WideString): WordBool; dispid 2;
    function GetCurrentOptionValue(const uniqueID: WideString): WideString; dispid 3;
  end;
