...
#define sptUTILS_FILES            24 // Выдать путь на каталог утилит
#define sptMULTY_UTILS_FILES      25 // Выдать список каталогов утилит
#define sptCURR_UTILS_FILES       26 // запоминание последних директориев, с которых выполнилось открытие/сохранение файла в диалоге Open|Save
#define sptPROGRAMDATA_FILES      27 // Выдать путь на каталог данных приложения ( C:\ProgramData\ASCON\KOMPAS-3D\18 )
...
#define CIRCULAR_CENTRES_OBJ   84        // Круговая сетка центров
#define LINEAR_CENTRES_OBJ     85        // Линейная сетка центров
#define ELLIPSE_ARC_AXIS_OBJ   86        // Дуговая осевая линия

#define MAX_VIEWTIP_SEARCH     87        // верхняя граница типов поиска для объектов вида  -
...
#define CONSTRAINT_CONCENTRICITY         22 // совпадение центров окружностей, дуг, эллипсов и точек
...
#define CURRENTCOLORSCHEME 4   //цвет установленный для объекта в текущей цветовой схеме
//-----------------------------------------------------------------------------
