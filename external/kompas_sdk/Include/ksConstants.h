 ...
 */
/* Compiler settings for D:/shared/workspace/KOMPAS/_RELEASES/releases-v21-x86/KOMPAS/Source/2D/00400_Sys4/libConsts.odl:
...
// ---
  ...
  // _1_18_ ksProcess2DNotifyEnum             - 18 События процесса 2D. 2
  // _1_19_ ksProcess3DNotifyEnum             - 19 События процесса 3D. 3
  // _1_20_ ksContentDialogNotifyEnum         - 20 События диалога с произвольным наполнением
  // _1_21_ ksFindObjectParametersNotifyEnum  - 21 События функции поиска объектов
  // _1_22_ ksProcess3DManipulatorsNotifyEnum - 22 События монипуляторов процесса 3D.
  // _1_23_ ksPLMObjectNotifyEnum             - 23 Cобытия объектов версионирования
  // _1_24_ ksFindObject3DParametersNotifyEnum- 24 События функции поиска объектов 3D
  //
  //
  // _1_108_ ksMaterialPropertyTypeEnum       - Тип выбора материала.
...
// ---
  ...
  // _2_28_ ksExternalFilesTypesEnum   - Тип внешнего файла.
  // _2_29_ ksBooleanType              - Типы булевых операций над твердыми телами и замкнутыми кривыми
  // _2_30_ ksSnapTypeEnum             - Тип привязки к объектам
   // _2_31_ ksNewDocumentSettingsTypeEnum - Тип настроек новых документов.
  // _2_32_ ksPrinterTypeEnum          - Текущий принтер.
  // _2_33_ ksSheetType                - Тип листа
  // _2_34_ ksDrawInScreenPlaneEnum    - Типы отображения объектов внешней триангуляции.
  // _2_35_ ksTextAlignEnum            - Выравнивание текста.
  // _2_36_ ksSlaveDocumentTypeEnum    - Типы подчиненных режимов редактирования документов КОМПАС
  // _2_37_ ksKompasVariantEnum        - Константы вариантов реализаций Компас.
  // _2_38_ ksCheckSumVersionEnum      - Версии котрольных сумм ICheckSum
  // _2_39_ ksRedrawDocumentModeEnum   - Режим перерисовки окнон документа
  // _2_40_ ksDocumentsLibraryInsertionTypeEnum - Типы документов в библиотеке документов КОМПАС.
  // _2_41_ ksProductObjectTypeEnum     - Тип объектов дерева СЧИ.
  // _2_42_ ksSaveDocumentVersionEnum   - Версия сохранения файла.
  // _2_43_ ksThemeEnum                 - Темы Компас
  // _2_44_ ksCurveStyleTypeEnum        - Тип стиля кривой
  // _2_45_ ksCurvePenTypeEnum          - Способ задания параметров пера
  // _2_46_ ksAccuracyEnum              - Количество знаков после запятой.
  // _2_47_ ksProtectProductStatusEnum  - Состояния (статус) защиты продукта.
  // _2_48_ ksKompasModuleEnum          - Модули Компас.
  // _2_49_ ksModelRenderTypeEnum       - Вариант отрисовки
  // _2_50_ ksModelPerformanceLevelEnum - Качество сглаживания.
  // _2_51_ ksModelTransparencyTypeEnum - Прозрачность.
  // _2_52_ ksPLMStatusEnum             - Статус в системе версионирования.
  // _2_53_ ksPLMChangesEnum            - Отличие в системе версионирования.
  // _2_54_ ksStylesLibraryTypeEnum     - Тип библиотеки стилей


//-------------------------------------------------------------------------------
// _3_ Константы панели свойств и процессов
// ---
  ...
  // _3_13_ ksCheckBoxVisualStyleEnum       - Визуальный стиль чекбокса
  // _3_14_ ksPhantomTypeEnum              - Типы фантома
  // _3_15_ ksProcess2DTypeEnum            - Типы процессов 2D
  // _3_16_ ksProcess3DTypeEnum            - Типы процессов 3D
  // _3_17_ ksTwinSwitcherValueEnum        - Значения переключателя
  // _3_18_ ksProcessContextMenuType       - Тип процессного меню
  // _3_19_ ksEnterButtonIconTypeEnum      - Тип иконки для кнопки создать


//-------------------------------------------------------------------------------
// _4_ Константы 2D документа
// ---
  // _4_01_ FilterConditionStateEnum       - Состояние параметра в условии фильтрации слоев
  ...
  // _4_64_ ksNurbsByPointsBuildingTypeEnum     - Способ формирования точек сплайна.
  // _4_65_ ksNurbsByPointsPointConstraintsEnum - Вариант управления точкой сплайна.
  // _4_66_ ksNurbsByPointsAproximationTypeEnum - Способ вычисления шага аппроксимации для точек сплайна
  // _4_67_ ksToleranceArrowType           - Тип стрелки ответвления у допуска формы
  // _4_68_ ksShowHideTmpObjTypeEnum       - Тип отображения временного объекта в документе.
  // _4_69_ ksConicCurvePontIndexEnum      - Индекс точки конической кривой
  // _4_70_ ksFindObjectsTypeEnum          - Тип поиска объектов.
  // _4_71_ ksNumericGroupTypeEnum         - Тип группы нумерации. Тип номера.
  // _4_72_ ksDimensionPointEnum           - Тип координаты точки размера.
  // _4_73_ ksDesignationPointEnum         - Типы точек обозначений.
  // _4_80_ ksAngleTypeEnum                - Признак типа угла.
...
// ---
  ...
  // _6_08_ ksSpecificationStyleDifferenceTypeEnum - Отличие стиля СП от библиотечного.
  // _6_09_ ksSpcUsedTypeEnum            - Признаки использования в спецификации.
...
// ---
  ...
  // _7_02_ ksReportFiltersTypeEnum - Типы фильтров в команде создать отчет.
   // _7_03_ ksVariantMarkingTypeEnum - Параметры формирования обозначения.
  // _7_04_ ksReportTypeEnum - Тип отчета
  // _7_05_ ksValueFormatEnum - Формат формирования текста для свойства.
  // _7_06_ ksGroupeTypeEnum  - Тип группировки колонки отчета.
  // _7_07_ ksNumberingTypeEnum - Формат нумерации.
  // _7_08_ ksRowsNumberingTypeEnum - Формат нумерации строк отчета.
  // _7_09_ ksReportStyleInitEnum - Способ инициализации стиля отчета.
  // _7_10_ ksReportBuildingTypeEnum - Способ выбора объектов для отчета.
  // _7_11_ ksPageLayoutTypeEnum - Тиn компоновки таблиц отчета.
  // _7_12_ ksObjectPropertyControlTypeEnum - Типы контролов для отображения свойств в окне свойств.
...
enum _ksDocument3DNotifyEnum
    {
        ...
        d3CreateEmbodiment	= 9,
        d3DeleteEmbodiment	= 10,
        d3ChangeCurrentEmbodiment	= 11,
...
enum _KompasAPIObjectTypeEnum
    {
        ...
        ksObjectNewPartDocumentSettings	= 10114,
        ksObjectNewAssemblyDocumentSettings	= 10115,
        ...
        ksObjectUnhistoredCurve3D	= 11165,
        ksObjectUnhistoredCurves3D	= 11166,
        ksObjectTechnicalDemand3D	= 11167,
        ksObjectEmbodiment	= 11168,
        ksObjectOperationLinearDimension	= 11169,
        ksObjectOperationAngularDimension	= 11170,
        ksObjectOperationRadialDimension	= 11171,
        ksObjectOperationDiametralDimension	= 11172,
        ksObjectSketchLinearDimension	= 11173,
        ksObjectSketchAngularDimension	= 11174,
        ksObjectSketchBreakAngularDimension	= 11175,
        ksObjectSketchRadialDimension	= 11176,
        ksObjectSketchBreakRadialDimension	= 11177,
        ksObjectSketchDiametralDimension	= 11178,
        ...
        ksObjectPointsArrOnSurface	= 11184,
...
//-------------------------------------------------------------------------------
// _3_10_ Начальное положение панели
// ---
...
enum _ProcessTypeEnum
    {
        ...
        prSpecRough3D	= 20184,
        prShmtLinearRuledOperation	= 20185,
        prRepositionPart	= 20186,
...
enum _FilterConditionStateEnum
    {
        ksStateUndefined	= -1,
        ksStateFALSE	= 0,
        ksStateTRUE	= 1
    } 	FilterConditionStateEnum;
...
enum _ksKOMPASConverterEnum
    {
        ...
        ksConverterToC3D	= 7,
        ksConverterToJT	= 8,
        ksConverterToSTEP_AP203	= 203,
        ksConverterToSTEP_AP214	= 214,
        ksConverterToSTEP_AP242	= 242
...
enum _ksKompasCommandEnum
    {
        ...
        ksCMRebuildSheetComplete	= 37082,
        ...
        ksCMCreateSheetFromObject	= 40723,
...
// _2_28_ ksExternalFilesTypesEnum - Тип внешнего файла.
// ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("9EF7CACA-16BC-4106-A2BF-DCE50E7FDF2B") 
enum _ksExternalFilesTypesEnum
    {
        ksEFTUnknown	= -1,
        ksEFTDocumentFile	= 0,
        ...
        ksEFTAssRprtTable	= 25,
        ksEFTEexternalHyperText	= 26,
  ...
  //------------------------------------------------------------------------------
  // _2_29_ Типы булевых операций над твердыми телами и замкнутыми кривыми
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("58EB5E98-755F-477b-8EAE-40356D8235D3") 
enum _BooleanType
    {
        ksBooleanUnknown	= 0,
        ksIntersect	= 1,
  ...
  //------------------------------------------------------------------------------
  // _2_30_ Тип привязки к объектам
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("F9E57A4F-F515-459b-A4E3-ED0515FD8DA3") 
enum _ksSnapTypeEnum
    {
        ksSTUnknown	= -1,
        ksSTUndefine	= 0,
        ksSTNearestPoint	= 1,
  ...
  // _2_31_ ksNewDocumentSettingsTypeEnum - Тип настроек новых документов.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("10662ADF-FE7C-4ba2-B734-EB87ED98B4B6") 
enum _ksNewDocumentSettingsTypeEnum
    {
        ksNewPartDocumentSettings	= 1
    } 	ksNewDocumentSettingsTypeEnum;

  //------------------------------------------------------------------------------
  // _1_108_ ksMaterialPropertyTypeEnum - Тип события выбора материала.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("FCBE2BE9-E4B8-4ae2-8DDE-0EE21CE92BCB") 
enum _ksMaterialPropertyTypeEnum
    {
        ksMPNewPartDocumentSettings	= 1
    } 	ksMaterialPropertyTypeEnum;

  //------------------------------------------------------------------------------
  // _7_03_ ksVariantMarkingTypeEnum - Параметры формирования обозначения.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("8CE4C7AC-EA8C-4027-8726-BF0518A5DEDB") 
enum _ksVariantMarkingTypeEnum
    {
        ksVMFullMarking	= -1,
        ksVMBaseMarking	= 0x1,
  ...
  // _7_04_ ksReportTypeEnum - Тип отчета.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("2E435FAE-AC8C-4f4f-9D9A-15B6698CFEA9") 
enum _ksReportTypeEnum
    {
  ...
  // _7_05_ ksValueFormatEnum - Формат формирования текста для свойства
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("6C94797E-068B-4b88-98B5-080C59FF7F4F") 
enum _ksValueFormatEnum
    {
        ksVFVariableValue	= ( 0x1 | 0x8 ) ,
        ksVFvvfToleranceDiv	= ( ( 0x2 | 0x4 )  | 0x8 ) ,
        ksVFvvfFullValue	= ( ( ( 0x1 | 0x2 )  | 0x4 )  | 0x8 ) ,
        ksVFvvfGridFullValue	= ( ( 0x1 | 0x2 )  | 0x4 ) ,
        ksVFBooleanValue	= 0x1,
        ksVFBooleanYesNo	= 0x2,
        ksVFBooleanPlusMinus	= 0x3,
        ksVFFullMarking	= 0x1,
        ksVFOnlyAdditionMarking	= 0x2
    } 	ksValueFormatEnum;

  //------------------------------------------------------------------------------
  // _7_06_ ksGroupeTypeEnum - Тип группировки колонки отчета
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("AB5E7492-47B9-4491-874C-32883AF18A58") 
enum _ksGroupeTypeEnum
    {
        ksGTNone	= 0,
        ksGTMatch	= 1,
        ksGTSum	= 2,
  ...
  // _7_07_ ksNumberingTypeEnum - Формат нумерации.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("E7DFA4A0-CDF0-4974-B360-AE2E9CF5409C") 
enum _ksNumberingTypeEnum
    {
  ...
  // _7_08_ ksRowsNumberingTypeEnum - Формат нумерации строк отчета.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("7BFE72BD-889B-4ad4-ACF7-F1DDE53CCC16") 
enum _ksRowsNumberingTypeEnum
    {
        ksRNTNone	= 0,
        ksRNTSimple	= 1,
        ksRNTMultiLevel	= 2
    } 	ksRowsNumberingTypeEnum;

  //------------------------------------------------------------------------------
  // _7_09_ ksReportStyleInitEnum - Способ инициализации стиля отчета.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("73033645-CB59-4096-8FAB-C431CF97BD5D") 
enum _ksReportStyleInitEnum
    {
        ksRSIDefault	= 0
    } 	ksReportStyleInitEnum;

  //------------------------------------------------------------------------------
  // _2_33_ ksSheetType - Тип листа
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("A81E89B8-2FE3-49c8-ADA6-AF7C63F89176") 
enum _SheetTypeEnum
    {
        ksDocumentSheet	= 0,
  ...
  //------------------------------------------------------------------------------
  // _2_34_ ksDrawInScreenPlaneEnum - Способ преобразования координат внешней триангуляции.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("7EFFC011-CDEE-4B7B-B9BE-51BFB117405F") 
enum _ksDrawInScreenPlaneEnum
    {
        ksDrawNone	= 0,
        ksDrawInScreenPlane	= 1,
        ksDrawProjectToScreen	= 2,
        ksDrawProjectFromScreen	= 3
    } 	ksDrawInScreenPlaneEnum;

  //------------------------------------------------------------------------------
  // _2_35_ ksTextAlignEnum - Выравнивание текста.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("0DD9E984-BDC1-41B4-B327-3E21264947DB") 
enum _ksTextAlignEnum
    {
        ksTALeft	= 0,
        ksTARight	= 2,
        ksTAHCenter	= 6,
  ...
  // _7_10_ ksReportBuildingTypeEnum - Способ выбора объектов для отчета.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("978AC4AB-2D1E-4d53-9058-4C01D1FD9FD6") 
enum _ksReportBuildingTypeEnum
    {
        ksRBAllObjects	= 0,
        ksRBChooseObjects	= 1,
        ksRBCurrentView	= 2,
        ksRBChoiceToLevel	= 3
    } 	ksReportBuildingTypeEnum;

  //------------------------------------------------------------------------------
  // _7_11_ ksPageLayoutTypeEnum - Тип компоновки таблиц отчета.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("E9209423-8B0B-4320-81CB-7BC36E342090") 
enum _ksPageLayoutTypeEnum
    {
        ksRPLayoutDefault	= 0,
        ksRPLayout1	= 1
    } 	ksPageLayoutTypeEnum;

  //------------------------------------------------------------------------------
  // _7_12_ ksObjectPropertyControlTypeEnum  - Типы контролов для отображения свойств в окне свойств.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("2142D68B-FF3A-4e66-9304-EBFF6DB2E6D6") 
enum _ksObjectPropertyControlTypeEnum
    {
        ksOPControlGroup	= 0,
        ksOPControlPointCoord	= 1,
        ksOPControlPointStyle	= 2,
        ksOPControlLineStyle	= 4,
        ksOPControlHatchStyle	= 5,
        ksOPControlColor	= 6,
        ksOPControlEditDouble	= 7,
        ksOPControlEditInt	= 10,
        ksOPControlListDouble	= 11,
        ksOPControlListInt	= 14,
        ksOPControlListCheck	= 15,
        ksOPControlListBmp	= 16,
        ksOPControlListString	= 17,
        ksOPControlSimpleText	= 19,
        ksOPControlText	= 25,
        ksOPControlEdit	= 31,
        ksOPControlExternalEdit	= 34,
        ksOPControlExternalStringEdit	= 35,
        ksOPControlFontImageList	= 38,
        ksOPControlExternalText	= 44,
        ksOPControlExternalMultyText	= 45,
        ksOPControlUserLineStyle	= 47
    } 	ksObjectPropertyControlTypeEnum;

  //------------------------------------------------------------------------------
  // _2_32_ ksPrinterTypeEnum - Текущий принтер.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("747F9EBC-E7EE-45d9-8EA2-471E2A68025B") 
enum _ksPrinterTypeEnum
    {
  ...
  // _6_08_ ksSpecificationStyleDifferenceTypeEnum - Отличие стиля СП от библиотечного.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("767EC7B7-FE71-4FDA-A0D3-A8BC0651CC1F") 
enum _ksSpecificationStyleDifferenceTypeEnum
    {
        ksSpcStyleEqual	= 0,
        ksSpcStyleDistinguish	= 1,
        ksSpcStyleNotFound	= -1
    } 	ksSpecificationStyleDifferenceTypeEnum;

//-------------------------------------------------------------------------------
// _2_36_ ksSlaveDocumentTypeEnum - Типы подчиненных режимов редактирования документов КОМПАС
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("18901E0A-EC8F-4FD4-9326-D6DBCB58B222") 
enum _ksSlaveDocumentTypeEnum
    {
        ksSDSketchMode	= 1000,
...
// _4_64_ ksNurbsByPointsBuildingTypeEnum - Способ формирования точек сплайна
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("0C495A54-ADFE-4842-ABF3-AACB63B82445") 
enum _ksNurbsByPointsBuildingTypeEnum
    {
        ksNByPBTUndefined	= 0,
        ksNByPBLinear	= 1,
...
// _4_65_ ksNurbsByPointsPointConstraintsEnum - Вариант управления точкой сплайна
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("8DA9E5C9-F17D-44C8-86BE-14E30A8E2DCA") 
enum _ksNurbsByPointsPointConstraintsEnum
    {
        ksNByPBPCNone	= 0,
        ksNByPBPCTangent	= 1,
        ksNByPBPCSmoothG2	= 2,
        ksNByPBPCNormal	= 3
    } 	ksNurbsByPointsPointConstraintsEnum;

//-------------------------------------------------------------------------------
// _4_66_ ksNurbsByPointsAproximationTypeEnum - Способ вычисления шага аппроксимации для точек сплайна
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("F3112C93-D4A7-4BAD-BD87-E4C33B076FA7") 
enum _ksNurbsByPointsAproximationTypeEnum
    {
        ksNBPAproximationStepByCurvature	= 0,
        ksNBPAproximationStepByDeviation	= 1
    } 	ksNurbsByPointsAproximationTypeEnum;

  //------------------------------------------------------------------------------
  // _2_37_ ksKompasVariantEnum - Константы вариантов реализаций Компас.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("B14ED0B9-8C84-4987-8EB2-0ACFFCB13246") 
enum _ksKompasVariantEnum
    {
        ksKompasPro	= 0,
        ksKompasHome	= 0x1,
        ksKompasViewer	= 0x2,
        ksKompasSpds	= 0x4,
        ksKompasGraphic	= 0x100,
        ksKompasInvisible	= 0x200,
        ksKompasLatin	= 0x400,
        ksKompasConsumer	= 0x1000,
        ksKompasStudy	= 0x2000
    } 	ksKompasVariantEnum;

//-------------------------------------------------------------------------------
// _3_13_ ksCheckBoxVisualStyleEnum - Визуальный стиль чекбокса
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("98244AE9-D5D5-4435-9F6C-CA5B92A3CB42") 
enum _ksCheckBoxVisualStyleEnum
    {
        ksCheckBoxDefault	= 0,
        ksCheckBoxSwitcher	= 1
    } 	ksCheckBoxVisualStyleEnum;

//-------------------------------------------------------------------------------
// _3_14_ ksPhantomTypeEnum - Типы фантома
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("53DE8B9A-8806-4ECE-9619-C6A799AAC6FC") 
enum _ksPhantomTypeEnum
    {
        ksUnknownPhantom	= 0,
...
// _3_15_ ksProcess2DTypeEnum - Типы процессов 2D
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("BFEFECA5-1EE1-4937-A12E-A39827DCEC6A") 
enum _ksProcess2DTypeEnum
    {
        ksProcess2DCursor	= 1,
  ...
  //-------------------------------------------------------------------------------
  // _1_18_ События процесса 2D.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("9EBD4C17-1A7C-4225-AFAF-9BC98C3BAEE0") 
enum _ksProcess2DNotifyEnum
    {
    ...
    } 	ksProcess2DNotifyEnum;

  //-------------------------------------------------------------------------------
  // _1_19_ События процесса 3D.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("A696A867-6D59-4E0A-8DDD-DFC30FF2A774") 
enum _ksProcess3DNotifyEnum
    {
    ...
    } 	ksProcess3DNotifyEnum;

//-------------------------------------------------------------------------------
// _3_16_ ksProcess3DTypeEnum                 - Типы процессов 3D
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("3FEF9E54-8B04-49F0-BD06-F4B0F131D036") 
enum _ksProcess3DTypeEnum
    {
...
// _3_17_ ksTwinSwitcherValueEnum                 - Значения переключателя
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("73B0D849-7E97-4653-A8A5-CB5C3AC51384") 
enum _ksTwinSwitcherValueEnum
    {
        ksTwinSwitcherPos1	= 1,
        ksTwinSwitcherPos2	= 2
    } 	ksTwinSwitcherValueEnum;

//-------------------------------------------------------------------------------
// _4_67_ ksToleranceArrowType - Тип стрелки ответвления у допуска формы
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("273FADE7-D399-456D-9AE6-4C34CF99704C") 
enum _ksToleranceArrowType
    {
        ksTANone	= 0,
        ksTAArrow	= 1,
        ksTATriangle	= 2
    } 	ksToleranceArrowType;

//-------------------------------------------------------------------------------
// _3_18_ ksProcessContextMenuType - Тип процессного меню
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("3FD254BD-E52B-482D-A146-8471512A8F58") 
enum _ksProcessContextMenuType
    {
        ksProcessDefaultContextMenu	= 0,
        ksProcessContextMenuHide	= -2,
        ksProcessContextPanel	= -3,
        ksProcessContextIconMenu	= -4
    } 	ksProcessContextMenuType;

//-------------------------------------------------------------------------------
// _3_19_ ksEnterButtonIconTypeEnum - Тип иконки для кнопки создать
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("4A5AF40B-E744-411E-8BE2-82BC79088FEB") 
enum _ksEnterButtonIconTypeEnum
    {
        ksEnterCheckIcon	= 0,
        ksEnterFloppyIcon	= 1,
        ksEnterNewInputIcon	= 2,
        ksEnterApplyIcon	= 3
    } 	ksEnterButtonIconTypeEnum;

//-------------------------------------------------------------------------------
// _4_68_ ksShowHideTmpObjTypeEnum - Тип отображения временного объекта в документе.
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("F3F85250-64AE-46FC-8861-1C5625986D06") 
enum _ksShowHideTmpObjTypeEnum
    {
        ksTmpObjHide	= 0,
        ksTmpObjShow	= 1,
        ksTmpObjShowPhantom	= 2
    } 	ksShowHideTmpObjTypeEnum;

//-------------------------------------------------------------------------------
// _2_40_ ksDocumentsLibraryInsertionTypeEnum - Типы документов в библиотеке документов КОМПАС.
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("BACBE7ED-0424-40F2-85AB-E4B05860495D") 
enum _ksDocumentsLibraryInsertionTypeEnum
    {
    ...
    } 	ksDocumentsLibraryInsertionTypeEnum;

//-------------------------------------------------------------------------------
// _2_39_ ksRedrawDocumentModeEnum - Режим перерисовки окнон документа
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("70413A6E-CC15-4B05-B4D8-EC6762CB5B60") 
enum _ksRedrawDocumentModeEnum
    {
        ksRedrawFull	= 0,
        ksRedrawAnimation	= 1,
        ksRedrawSelection	= 2,
        ...
        ksRedrawWidgets	= 7
    } 	ksRedrawDocumentModeEnum;

//-------------------------------------------------------------------------------
// _2_41_ ksProductObjectTypeEnum - Тип объектов дерева СЧИ.
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("B0C01032-143C-4613-A5BE-326BF96911F8") 
enum _ksProductObjectTypeEnum
    {
        ksPOTAllObjects	= -1,
        ksPOTDocumentObject	= 0x1,
        ksPOTEmbodimentsObject	= 0x2,
        ksPOTPartObject	= 0x4,
        ksPOTBodyObject	= 0x8,
        ksPOTProductObject	= 0x10,
        ksPOTInformObject	= 0x20,
        ksPOTSurfaceObject	= 0x40,
        ksPOTBillet	= 0x80,
        ksPOTGroupObject	= 0x100
    } 	ksProductObjectTypeEnum;

//-------------------------------------------------------------------------------
// _2_42_ ksSaveDocumentVersionEnum - Версия сохранения файла.
// ---
typedef /* [helpcontext][helpstring][v1_enum][uuid] */  DECLSPEC_UUID("EBC63884-6B1A-403A-AF60-480B6C5D3CAF") 
enum _ksSaveDocumentVersionEnum
    {
        ksSDV_Prev	= -1,
        ksSDV_Current	= 0,
  ...
  //-------------------------------------------------------------------------------
  // _1_20_ ksContentDialogNotifyEnum - События диалога с произвольным наполнением
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("4DE27FA4-B163-4F57-952A-7869C27F2EEF") 
enum _ksContentDialogNotifyEnum
    {
        ksCDCreateContentCallback	= 1,
        ksCDDestroyContent	= 2,
        ksCDExecuteCommand	= 3,
        ksCDButtonUpdate	= 4
    } 	ksContentDialogNotifyEnum;

  //-------------------------------------------------------------------------------
  // _2_43_  ksThemeEnum - Темы Компас
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("076E8381-8C39-49CB-95FF-0D512699150B") 
enum _ksThemeEnum
    {
        ksThemeLight	= 0,
        ksThemeDark	= 2
  ...
  // _6_09_ ksSpcUsedTypeEnum - Признаки использования в спецификации.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("C0D51347-367E-4D1C-8C0B-87321B56BD97") 
enum _ksSpcUsedTypeEnum
    {
  ...
  // _4_69_ ksConicCurvePontIndexEnum Индекс точки конической кривой
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("4C3851FD-0CD9-490A-BC65-A4818942490D") 
enum _ksConicCurvePontIndexEnum
    {
        ksCCBeginPoint	= 0,
        ksCCEndPoint	= 1,
  ...
  // _4_70_ ksFindObjectsTypeEnum - Тип поиска объектов.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("FD9DD98B-5115-4958-91E6-59F368FE616B") 
enum _ksFindObjectsTypeEnum
    {
        ksFindObjByType	= -1,
        ksFindAll	= 0,
        ksFindAnyCurve	= 1,
    ...
    } 	ksFindObjectsTypeEnum;

  //-------------------------------------------------------------------------------
  // _1_21_ ksFindObjectParametersNotifyEnum - События функции поиска объектов
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("C9296C0A-A567-4CEC-B77A-1BA5FC04BFBD") 
enum _ksFindObjectParametersNotifyEnum
    {
        ksFOPFilterObject	= 1
    } 	ksFindObjectParametersNotifyEnum;

  //-------------------------------------------------------------------------------
  // _1_22_ События монипуляторов процесса 3D.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("BEE10610-BBC3-4047-8C96-AAA988F0CA06") 
enum _ksProcess3DManipulatorsNotifyEnum
    {
    ...
    } 	ksProcess3DManipulatorsNotifyEnum;

//-------------------------------------------------------------------------------
// _4_57_ ksPointLocationTypeEnum - Положение двумерной точки относительно двумерной кривой.
// ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("C4F59A06-7531-4A3A-A38B-4FAB1932FDF9") 
enum _ksPointLocationTypeEnum
    {
        ksPLUndefined	= 0,
        ksPLOutside	= 1,
        ksPLOnCurve	= 2,
        ksLPInside	= 3
    } 	ksPointLocationTypeEnum;

  //-------------------------------------------------------------------------------
  // _2_54_ ksStylesLibraryTypeEnum - Тип библиотеки стилей
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("21591528-0B22-4A2F-BD52-EC99CC6A4EBA") 
enum _ksStylesLibraryTypeEnum
    {
    ...
    } 	ksStylesLibraryTypeEnum;

  //-------------------------------------------------------------------------------
  // _2_44_  ksCurveStyleTypeEnum - Тип стиля кривой
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("90739B68-EF87-4E65-B53B-3C71FAC5F068") 
enum _ksCurveStyleTypeEnum
    {
        ksCSTSoldLine	= 0,
        ksCSTBrokenLine	= 1
    } 	ksCurveStyleTypeEnum;

  //-------------------------------------------------------------------------------
  // _2_45_  ksCurvePenTypeEnum - Способ задания параметров пера
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("193CDF8E-05DA-448D-852F-BE9C7E632DBF") 
enum _ksCurvePenTypeEnum
    {
        ksCPTIndependent	= 0,
        ksCPTBasicLine	= 1,
        ksCPTThinLine	= 2,
...
// _2_46_ ksAccuracyEnum - Количество знаков после запятой.
// ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("DD4B14DE-4971-45D7-84F5-F8EE38A51686") 
enum _ksAccuracyEnum
    {
        ksAccuracyDefault	= -1,
        ksAccuracy0	= 0,
        ksAccuracy1	= 1,
  ...
  // _2_47_  ksProtectProductStatusEnum - Состояния (статус) защиты продукта.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("88ED7913-5597-46F2-9878-C18DA39CEAC1") 
enum _ksProtectProductStatusEnum
    {
        ksProtectUnknown	= 0,
        ksProtectDemo	= 1,
        ksProtectDisabled	= 2,
  ...
  // _2_48_  ksKompasModuleEnum - Модули Компас.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("DA2B2C00-B814-4035-8E93-6DC3F0F62DF9") 
enum _ksKompasModuleEnum
    {
        ksKompasModule2D	= 1,
        ksKompasModule3D	= 2,
        ksKompasPrint	= 100,
  ...
  // _2_49_  ksModelRenderTypeEnum - Вариант отрисовки.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("E6AB3078-B3A4-401A-ADC6-DABB8CDBE9BA") 
enum _ksModelRenderTypeEnum
    {
        ksModelRenderNone	= -1,
        ksModelRenderAuto	= 0,
        ...
        ksModelRenderLow	= 3
    } 	ksModelRenderTypeEnum;

  //-------------------------------------------------------------------------------
  // _2_50_  ksModelPerformanceLevelEnum - Качество сглаживания.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("207FAF83-CBB7-433A-A67F-8089AA542CD9") 
enum _ksModelPerformanceLevelEnum
    {
        ksMPLDisabledAntialiasing	= 0,
        ksMPLLowAntialiasing	= 1,
        ksMPLNormalAntialiasing	= 2,
        ksMPLHightAntialiasing	= 3
    } 	ksModelPerformanceLevelEnum;

  //-------------------------------------------------------------------------------
  // _2_51_ ksModelTransparencyTypeEnum - Прозрачность.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("C47DCEAF-4119-4707-8C67-D8E53271A6F0") 
enum _ksModelTransparencyTypeEnum
    {
        ksModelTransparencyMesh	= 0,
        ksModelTransparencyRealistic	= 1
    } 	ksModelTransparencyTypeEnum;

 //-------------------------------------------------------------------------------
 // _2_52_ ksPLMStatusEnum - Статус в системе версионирования.
 // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("7DCC6E91-2FCA-4087-A68F-39DCD9C1A9A7") 
enum _ksPLMStatusEnum
    {
...
//------------------------------------------------------------------------------
 // _2_53_ ksPLMChangesEnum Отличие в системе версионирования.
 // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("E1FC5160-9A9A-4357-AD29-96E74FE7CC5C") 
enum _ksPLMChangesEnum
    {
  ...
  //-------------------------------------------------------------------------------
  // _1_23_ ksPLMObjectNotifyEnum Cобытия объектов версионирования
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("A7929D4A-6B91-4F84-8DE3-C3CA57AFE61A") 
enum _ksPLMObjectNotifyEnum
    {
        ksPLMStatusChanged	= 1001,
        ksPLMChangeChanged	= 1002,
        ksPLMValueChanged	= 1003
    } 	ksPLMObjectNotifyEnum;

  //-------------------------------------------------------------------------------
  // _1_24_ ksFindObject3DParametersNotifyEnum - События функции поиска объектов 3D
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("B950CFC1-4CD3-4D79-B479-6107AE48F309") 
enum _ksFindObject3DParametersNotifyEnum
    {
        ksFOPFilterObject3D	= 1
    } 	ksFindObject3DParametersNotifyEnum;

  //-------------------------------------------------------------------------------
  // _4_71_ ksNumericGroupTypeEnum - Тип группы нумерации. Тип номера.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("97F169BB-7828-46B8-AA93-4128F6EFE137") 
enum _ksNumericGroupTypeEnum
    {
        ksNumericGroupNumbers	= 0,
        ksNumericGroupSymbols	= 1
    } 	ksNumericGroupTypeEnum;

  //-------------------------------------------------------------------------------
  // _4_72_ ksDimensionPointEnum - Типы точек размеров.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("666801A1-8F37-4ED2-A5B7-D6D6FC87B9F6") 
enum _ksDimensionPointEnum
    {
        ksDimensionTextPoint	= 0,
        ksDimensionBasePoint	= 1,
        ksDimensionShelfPoint	= 2,
        ksDimensionLinePoint	= 3
    } 	ksDimensionPointEnum;

  //-------------------------------------------------------------------------------
  // _4_73_ ksDesignationPointEnum - Типы точек обозначений.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("A9841F2C-2599-4FFB-8BE7-E93D8AFD7C1B") 
enum _ksDesignationPointEnum
    {
        ksDesignationBasePoint	= 1,
        ksDesignationShelfPoint	= 2
    } 	ksDesignationPointEnum;

  //-------------------------------------------------------------------------------
  // _4_74_ ksRasterFormatEnum - Типы изображения.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("C5F67E88-C1CA-430D-A3CF-AB19A210569E") 
enum _ksRasterFormatEnum
    {
        ksRasterFormatBMP	= 0,
        ksRasterFormatGIF	= 1,
        ksRasterFormatJPG	= 2,
  ...
  //-------------------------------------------------------------------------------
  // _1_23_ ksPLMPropertyEnum Cобытия объектов версионирования
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("10943E5E-C695-4E66-B6C2-68E5C8737558") 
enum _ksPLMPropertyEnum
    {
  ...
  //-------------------------------------------------------------------------------
  // _4_75_ ksMultiPageOutputEnum - Многостраничный вывод.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("BCC7F2C2-AE1C-46EB-A367-72F62042BA27") 
enum _ksMultiPageOutputEnum
    {
        ksMultiPageOff	= 0,
        ksMultiPageOn	= 1,
        ksMultiPageOn2	= 2
    } 	ksMultiPageOutputEnum;

  //-------------------------------------------------------------------------------
  // _4_76_ ksColorBPPEnum - Цвет.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("7679CD14-D268-451E-A3E6-028754EB11D0") 
enum _ksColorBPPEnum
    {
        ksColorBPP_O1	= 1,
        ksColorBPP_O2	= 2,
        ksColorBPP_O4	= 4,
  ...
  //-------------------------------------------------------------------------------
  // _4_77_ ksObjectColorTypeEnum - Тип цвета.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("5461EAD5-35A1-4A8F-A1F9-724A9C17DB71") 
enum _ksObjectColorTypeEnum
    {
        ksColorBw	= 0,
        ksColorView	= 1,
        ksColorLayer	= 2,
    ...
    } 	ksObjectColorTypeEnum;

  //-------------------------------------------------------------------------------
  // _4_78_ ksRoughModificationEnum  - Вариант создания шероховатости.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("00767912-2552-4DA2-B27D-1ED8D40B13FE") 
enum _ksRoughModificationEnum
    {
        ksRoughModification1973	= 0,
        ksRoughModification2003	= 1
    } 	ksRoughModificationEnum;

  //-------------------------------------------------------------------------------
  // _4_79_ ksDecimalDelimiterTypeEnum  - Разделитель десятичной части размеров.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("7F5042CC-038C-4E1E-9C19-0E4D20A58BB4") 
enum _ksDecimalDelimiterTypeEnum
    {
        ksDecimalComma	= 0,
        ksDecimalPoint	= 1
    } 	ksDecimalDelimiterTypeEnum;

  //-------------------------------------------------------------------------------
  // _4_80_ ksAngleTypeEnum  - Признак типа угла.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("4179B9F5-326E-4527-B22D-4063BA3B478C") 
enum _ksAngleTypeEnum
    {
        ksError	= -2,
        ksConcave	= -1,
        ksNeutral	= 0,
  ...
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("19AC69E2-BC45-46D2-81D0-E35B3403EAE1") 
enum _ksMathCurve2DTypeEnum
    {
    ...
    } 	ksMathCurve2DTypeEnum;

  //-------------------------------------------------------------------------------
  // _4_81_ ksCurvesIntectFormEnum   - Тип пересечения.
  // ---
typedef /* [v1_enum][helpcontext][helpstring][uuid] */  DECLSPEC_UUID("9C210CFF-0F4B-43E4-98CE-E875BB2E30FB") 
enum _ksCurvesIntectFormEnum
    {
        ksCurvesIntectSimple	= 0,
        ksCurvesIntectTangent	= 1
    } 	ksCurvesIntectFormEnum;
