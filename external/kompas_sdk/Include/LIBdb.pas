...
// ---
function CreateDB( s : PAnsiChar ):reference; stdcall;  //s  - тип БД "TXT_DB"- текстовый файл  "ODBC_DB" - ODBC база
...
function ConnectDB( db : reference; //указатель на объект БД
                    DBName : PAnsiChar ) : integer; stdcall;//имя БД ( для ODBC - имя БД в администраторе ODBC, для текстового файла - имя файла )
...
function DoStatement( db    :  reference;
                      r     :  reference;
                      stSQL :  PAnsiChar ) : integer; stdcall;
...
// ---
function  RDouble( name : PAnsiChar ) : integer;
                    stdcall;
...
// ---
function  RFloat( name : PAnsiChar ) : integer; stdcall;
...
// ---
function RInt( name : PAnsiChar ) : integer; stdcall;
...
// ---
function RLong( name : PAnsiChar ) : integer; stdcall;
...
// ---
function RChar( name : PAnsiChar;  //имя колонки; действительно для TXT баз
...
// ---
function OpenTextFile( fileName : PAnsiChar ) : reference; stdcall;
...
function GetTableName( db : Reference;       // db - указатель БД
                       tableName : PAnsiChar;    // возвращает имя таблицы
                       size : Integer;       // размер буфера
...
function GetColumnName( db : Reference;      // db - указатель БД
                        tableName : PAnsiChar;   // ODBC-имя таблицы,текстовая БД-имя файла
                        columnName : PAnsiChar;  // возвращаент имя колонки
                        size : Integer;      // размер буфера
