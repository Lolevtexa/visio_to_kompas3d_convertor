...
#ifdef _UNICODE
#define ksGetObjectsNameByTypeT  ksGetObjectsNameByTypeW
#else
#define ksGetObjectsNameByTypeT  ksGetObjectsNameByType
#endif // !UNICODE
...
// Вернуть имя объекта по его типу
// ---
int LIB_FUNC ksGetObjectNameByTypeW( int type, LPWSTR name, unsigned int bufLen );


#ifdef _UNICODE
#define ksGetObjectNameByTypeT  ksGetObjectNameByTypeW
#else
#define ksGetObjectNameByTypeT  ksGetObjectNameByType
#endif // !UNICODE
