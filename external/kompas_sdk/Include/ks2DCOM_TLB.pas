...
// $Rev: 52393 $
// File generated on 18.05.2022 15:43:10 from Type Library described below
...
// SYS_KIND: SYS_WIN32
// Errors:
//   Hint: Parameter 'Set' of IPropertyManagerNotify.EditFocus changed to 'Set_'
// ************************************************************************ //
...
const
  ...
  IID_IProcess2DNotify: TGUID = '{225DDE9A-A442-4CD5-8428-87612BC0677A}';
  IID_IParametrizationParam: TGUID = '{ABBA6CE0-CB4C-4A32-98B4-B639352C75CC}';
  IID_ISnapInfo: TGUID = '{90570C5F-3837-40D8-B9E4-563C166A4FD0}';
  IID_ISaveToPreviusParam: TGUID = '{7C790DE5-BD3E-4F34-BF7A-7FA7250A87C0}';
  IID_IRasterFormatParam: TGUID = '{7AA0E540-0318-11D4-A30E-00C026EE094F}';
  IID_IMouseEnterLeaveParameters: TGUID = '{C78AE949-84F6-4291-83E5-6AEBF90D2E09}';
type
...
// *********************************************************************//
  ...
  IProcess2DNotify = interface;
  IParametrizationParam = interface;
  ISnapInfo = interface;
  ISaveToPreviusParam = interface;
  IRasterFormatParam = interface;
  IMouseEnterLeaveParameters = interface;
...
// *********************************************************************//
  IKompasObjectNotify = interface(IKompasNotify)
    ...
    function CreateDocument(pDoc: Integer; docType: SYSINT): WordBool; stdcall;
    function BeginOpenDocument(docName: PAnsiChar): WordBool; stdcall;
    ...
    function BeginRequestFiles(requestID: Integer; var files: OleVariant): WordBool; stdcall;
    function BeginChoiceMaterial(MaterialPropertyId: Integer): WordBool; stdcall;
    function ChoiceMaterial(MaterialPropertyId: Integer; material: PAnsiChar; density: Double): WordBool; stdcall;
    function IsNeedConvertToSavePrevious(pDoc: Integer; docType: SYSINT; saveVersion: Integer; 
                                         const saveToPreviusParam: IUnknown; 
                                         var needConvert: WordBool): WordBool; stdcall;
    function BeginConvertToSavePrevious(pDoc: Integer; docType: SYSINT; saveVersion: Integer; 
                                        const saveToPreviusParam: IUnknown): WordBool; stdcall;
    function EndConvertToSavePrevious(pDoc: Integer; docType: SYSINT; saveVersion: Integer; 
                                      const saveToPreviusParam: IUnknown): WordBool; stdcall;
    function ChangeTheme(newTheme: Integer): WordBool; stdcall;
    function BeginDragOpenFiles(var filesList: OleVariant; insert: WordBool; 
                                var filesListChanged: WordBool): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IDocumentFileNotify = interface(IKompasNotify)
    ...
    function BeginSaveDocument(docName: PAnsiChar): WordBool; stdcall;
    ...
    function BeginProcess(Id: Integer): WordBool; stdcall;
    function EndProcess(Id: Integer; Success: WordBool): WordBool; stdcall;
    function BeginAutoSaveDocument(docName: PAnsiChar): WordBool; stdcall;
    function AutoSaveDocument: WordBool; stdcall;
  end;
...
// *********************************************************************//
  IStampNotify = interface(IKompasNotify)
    ...
    function StampBeginClearCells(numbers: OleVariant): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IObject2DNotify = interface(IKompasNotify)
    ...
    function BeginPropertyChanged(objRef: Integer): WordBool; stdcall;
    function PropertyChanged(objRef: Integer): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IObject2DNotifyResult = interface(IUnknown)
    ...
    function GetSheetPoint(from: WordBool; out x: Double; out y: Double): WordBool; stdcall;
    function GetCopyObject: Integer; stdcall;
    function GetAngle: Double; stdcall;
    function GetScale(out sx: Double; out sy: Double): WordBool; stdcall;
    function GetProcessType: Integer; stdcall;
    function IsUndoMode: WordBool; stdcall;
    function IsRedoMode: WordBool; stdcall;
  end;
...
// *********************************************************************//
  ISpcObjectNotify = interface(IKompasNotify)
    ...
    function DocumentAdd(objRef: Integer; docName: PAnsiChar): WordBool; stdcall;
    function DocumentRemove(objRef: Integer; docName: PAnsiChar): WordBool; stdcall;
...
// *********************************************************************//
  ISpcDocumentNotify = interface(IKompasNotify)
    ...
    function DocumentAdd(docName: PAnsiChar): WordBool; stdcall;
    function DocumentBeginRemove(docName: PAnsiChar): WordBool; stdcall;
    function DocumentRemove(docName: PAnsiChar): WordBool; stdcall;
    function SpcStyleBeginChange(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
    function SpcStyleChange(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
  end;
...
// *********************************************************************//
  ISpecificationNotify = interface(IKompasNotify)
    ...
    function TuningSpcStyleBeginChange(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
    function TuningSpcStyleChange(libName: PAnsiChar; numb: Integer; isOk: WordBool): WordBool; stdcall;
    function ChangeCurrentSpcDescription(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
    function SpcDescriptionAdd(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
    function SpcDescriptionRemove(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
    function SpcDescriptionBeginEdit(libName: PAnsiChar; numb: Integer): WordBool; stdcall;
    function SpcDescriptionEdit(libName: PAnsiChar; numb: Integer; isOk: WordBool): WordBool; stdcall;
...
// *********************************************************************//
  IDocument2DNotify = interface(IKompasNotify)
    ...
    function BeginChoiceProperty(objRef: Integer; propID: Double): WordBool; stdcall;
    function ChoiceProperty(objRef: Integer; propID: Double): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IPropertyManagerNotify = interface(IKompasNotify)
    ...
    function EditFocus(const ctrl: IUnknown; Set_: WordBool): WordBool; stdcall;
    function UserMenuCommand(const ctrl: IUnknown; menuID: Integer): WordBool; stdcall;
    function LayoutChanged: WordBool; stdcall;
    function GetContextMenuType(LX: Integer; LY: Integer; var ContextMenuType: Integer): WordBool; stdcall;
    function FillContextPanel(const ContextPanel: IUnknown): WordBool; stdcall;
    function FillContextIconMenu(const menu: IUnknown): WordBool; stdcall;
    function EndEditItem(const ctrl: IUnknown; Index: Integer): WordBool; stdcall;
    function ChangeTabExpanded(TabIndex: Integer): WordBool; stdcall;
    function DoubleClickItem(const Control: IUnknown; Index: Integer): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IDocumentFrameNotify = interface(IKompasNotify)
    ...
    function ShowOcxTree(const tree: IUnknown; show: WordBool): WordBool; stdcall;
    function BeginPaintTmpObjects: WordBool; stdcall;
    function ClosePaintTmpObjects: WordBool; stdcall;
  end;
...
// *********************************************************************//
  ILibraryManagerNotify = interface(IKompasNotify)
    ...
    function TryExecute(const PLibrary: IUnknown; commandId: Integer): WordBool; stdcall;
    function BeginInsertDocument(const PLibrary: IUnknown; InsertionType: Integer; 
                                 const Insertion: WideString): WordBool; stdcall;
  end;
...
// *********************************************************************//
  IProcess2DNotify = interface(IKompasNotify)
    ['{225DDE9A-A442-4CD5-8428-87612BC0677A}']
    function PlacementChange(x: Double; y: Double; angle: Double; dynamic: WordBool): WordBool; stdcall;
    ...
    function GetMouseEnterLeavePoint(const Control: IUnknown; btnID: Integer; pointIndex: Integer; 
                                     const parameters: IUnknown): WordBool; stdcall;
...
// *********************************************************************//
  ISnapInfo = interface(IUnknown)
    ['{90570C5F-3837-40D8-B9E4-563C166A4FD0}']
    function GetSnapType1: Integer; stdcall;
    function GetObject1: Integer; stdcall;
    function GetSnapType2: Integer; stdcall;
    function GetObject2: Integer; stdcall;
    function GetPoint(out x: Double; out y: Double): WordBool; stdcall;
  end;
...
// *********************************************************************//
  ISaveToPreviusParam = interface(IUnknown)
    ['{7C790DE5-BD3E-4F34-BF7A-7FA7250A87C0}']
    function AddWarning(const uniqueID: WideString; const optionName: WideString; 
                        const text: WideString): WordBool; stdcall;
    function AddOption(const uniqueID: WideString; const optionName: WideString; 
                       options: OleVariant; const defaultValue: WideString): WordBool; stdcall;
    function GetCurrentOptionValue(const uniqueID: WideString): WideString; stdcall;
  end;
...
// *********************************************************************//
  IRasterFormatParam = interface(IUnknown)
    ...
    function SetGreyScale(f: Integer): Integer; stdcall;
    ...
    function SetOnlyThinLine(f: Integer): Integer; stdcall;
    ...
    function SetMultiPageOutput(f: Integer): Integer; stdcall;
    function Init: Integer; stdcall;
    function GetSaveWorkArea: Integer; stdcall;
    function SetSaveWorkArea(f: Integer): Integer; stdcall;
    function GetReturnResultAsArrayBytes: Integer; stdcall;
    function SetReturnResultAsArrayBytes(f: Integer): Integer; stdcall;
    function GetResultArrayBytes: OleVariant; stdcall;
    function SetResultArrayBytes(f: OleVariant): Integer; stdcall;
  end;
...
// *********************************************************************//
  IMouseEnterLeaveParameters = interface(IUnknown)
    ['{C78AE949-84F6-4291-83E5-6AEBF90D2E09}']
    function GetX: Double; stdcall;
    procedure SetX(NewVal: Double); stdcall;
    function GetY: Double; stdcall;
    procedure SetY(NewVal: Double); stdcall;
    function GetOffset: Double; stdcall;
    procedure SetOffset(NewVal: Double); stdcall;
    function GetOffsetAngle: Double; stdcall;
    procedure SetOffsetAngle(NewVal: Double); stdcall;
    function GetSymbol: Integer; stdcall;
    procedure SetSymbol(NewVal: Integer); stdcall;
    function GetSymbolFont: WideString; stdcall;
    procedure SetSymbolFont(const NewVal: WideString); stdcall;
    function GetSymbolColor: Integer; stdcall;
    procedure SetSymbolColor(NewVal: Integer); stdcall;
    function GetSymbolScale: Double; stdcall;
    procedure SetSymbolScale(NewVal: Double); stdcall;
  end;
